...
import ru.vsu.cs.boldyrev.model.fabrics.CloudFactory;
import ru.vsu.cs.boldyrev.model.shape.BackgroundSky;
import ru.vsu.cs.boldyrev.model.shape.Cloud;
import ru.vsu.cs.boldyrev.model.shape.Hills;
import ru.vsu.cs.boldyrev.model.shape.Moon;
import ru.vsu.cs.boldyrev.model.shape.Mountain;
import ru.vsu.cs.boldyrev.model.shape.Road;
import ru.vsu.cs.boldyrev.model.shape.RoadSign;
import ru.vsu.cs.boldyrev.model.shape.Star;
import ru.vsu.cs.boldyrev.model.shape.Sun;
import ru.vsu.cs.boldyrev.model.shape.Tree;
...
public class Picture {
    ...
    private final int CLOUD_AMOUNT = 10;

    private List<Cloud> clouds = CloudFactory.getClouds(CLOUD_AMOUNT);
    ...
    private void cloudAnimation() {
        ...
        if (flag) {
            ...
            allObjects.removeIf(obj -> obj instanceof Cloud);

            // Добавляем новые облака
            allObjects.addAll(clouds);
        }
    }
